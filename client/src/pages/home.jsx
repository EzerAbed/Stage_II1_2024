                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      ...
                      <p className="card-text mb-2">
                        <small className="text-body-secondary">The latest best collection in our closet <br />Feel Cute with our outfits</small>
                      </p>
                      <Link to='blog'>
                  ...
                  <div className="col-md-8">
                    <div className='back-details'>
                      ...
                      <div className='text-with-button'>
                        ...
                        <Link to='/shop' className='mt-4' id='button-link'>Shop Now</Link>
                      </div>
                    </div>
                  </div>
                </div>
